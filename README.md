...
https://docs.ros.org/en/jazzy/Installation/Ubuntu-Install-Debs.html
    ...
    2-2. xeyes 설치 => turtlesim GUI 띄우기 위해<br>
    설치 : sudo apt install x11-apps<br>
    실행 : xeyes

3. turtlesim 노드 실행<br>
$ros2 run turtlesim turtlesim_node

    3-1. 새로운 이름의 turtle 생성<br>
