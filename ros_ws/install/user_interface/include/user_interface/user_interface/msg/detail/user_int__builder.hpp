...
class Init_UserInt_user_int1
{
public:
  explicit Init_UserInt_user_int1(::user_interface::msg::UserInt & msg)
  : msg_(msg)
  {}
  Init_UserInt_user_int2 user_int1(::user_interface::msg::UserInt::_user_int1_type arg)
  {
    msg_.user_int1 = std::move(arg);
...
public:
  ...
  {}
  Init_UserInt_user_int1 header(::user_interface::msg::UserInt::_header_type arg)
  {
    msg_.header = std::move(arg);
    return Init_UserInt_user_int1(msg_);
  }
