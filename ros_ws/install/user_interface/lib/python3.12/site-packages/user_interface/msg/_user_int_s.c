...
bool user_interface__msg__user_int__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // user_int1
    PyObject * field = PyObject_GetAttrString(_pymsg, "user_int1");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->user_int1 = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // user_int2
...
PyObject * user_interface__msg__user_int__convert_to_py(void * raw_ros_message)
{
  ...
  {  // user_int1
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->user_int1);
    {
      int rc = PyObject_SetAttrString(_pymessage, "user_int1", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
