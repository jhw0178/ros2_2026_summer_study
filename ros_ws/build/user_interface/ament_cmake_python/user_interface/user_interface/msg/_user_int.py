...
class UserInt(metaclass=Metaclass_UserInt):
    ...
    def __init__(self, **kwargs):
        ...
        self.user_int1 = kwargs.get('user_int1', int())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.user_int1 != other.user_int1:
            return False
    ...
    @builtins.property
    def user_int1(self):
        """Message field 'user_int1'."""
        return self._user_int1

    @user_int1.setter
    def user_int1(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'user_int1' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'user_int1' field must be an integer in [-2147483648, 2147483647]"
        self._user_int1 = value
