...
def generate_launch_description():
    ...
    bridge = Node(
        ...
        remappings=[("/model/vehicle_1/joint_state", "/joint_states"),
                    ("/world/empty/model/vehicle_1/link/camera_link/sensor/front_camera/camera_info", "/vehicle_1/camera/camera_info"),
                    ("/world/empty/model/vehicle_1/link/camera_link/sensor/fron_camera/image", "/vehicle_1/camera/image"),
                    ("/model/vehicle_test/joint_state", "/joint_states"),
                    ("/world/empty/model/vehicle_test/link/camera_link/sensor/front_camera/camera_info", "/vehicle_test/camera/camera_info"),
                    ("/world/empty/model/vehicle_test/link/camera_link/sensor/fron_camera/image", "/vehicle_test/camera/image")
                    ],
        parameters=[
            {
